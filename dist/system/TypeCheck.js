System.register('TypeCheck', [], (function (exports) {
  ...
  return {
    execute: (function () {
      ...
      */
      var _tc = exports('_tc', function _tc(typeExp, __function, params) {
        return function () {
          var arguments$1 = arguments;
      ...
      * @see directory test for more information and examples
      */
      var _tcx = exports('_tcx', function _tcx(typeExp, __function, params) {
       ...
       * @see directory test for more information and examples
       */
      var validType = exports('validType', function validType(typeExp, inputVal) {
